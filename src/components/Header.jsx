    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button
            click={() => setOpen(false)}
            className="hover:shadow-[inset_154px_0_0_0_white] shrink-0"
            text="Sign Up"
          />
        </ul>
        {/* navbar */}
        ...
        >
          ...
          >
            <span
              className={`w-full h-[5px] duration-300 bg-[#02CDCF] rounded ${
        ...
        <div className="grow max-w-[1164px] w-full flex flex-col justify-center min-[1200px]:justify-start mx-auto px-3 min-[1200px]:mt-[104px]">
          ...
          >
            ...
            <Button
              className="hover:shadow-[inset_198px_0_0_0_white]"
              text="Know More"
            />
          </div>
        </div>
