            ...
            <div className="max-w-[620px] h-[449px] flex flex-col items-end w-full overflow-y-auto min-[1200px]:mt-[110px] min-[1200px]:ml-[17px] pl-10">
              {section6data.map((data, index) => (
                <div
                  ...
                  } ${index == 0 ? "before:rounded-t-[15px]":index==5?"before:rounded-b-[15px]":""}`}
                >
                  <h3 className="f-recharge font-bold text-xl sm:text-[24px] sm:leading-[31.2px] text-white mb-4">
                    {data.heading}
                  </h3>
                  <p className="font-poppins font-normal text-base leading-[25.6px] text-[rgba(255,255,255,0.7)] relative before:absolute before:w-[24px] before:h-[24px] before:bg-[#FCFCFC] before:rounded-[50%] before:top-[40px] before:left-[-40px] min-[600px]:before:left-[-84px]">
                    {data.para}
                  </p>
                </div>
              ))}
              ...
              <img className='absolute hidden md:block w-[209px] h-[207px] top-[1%] right-[-15%] lg:right-[-9%]' src={section6ring} alt="ring" />
